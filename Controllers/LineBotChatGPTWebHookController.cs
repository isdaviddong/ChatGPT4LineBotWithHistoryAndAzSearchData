...
namespace isRock.Template
{
    public class LineBotChatGPTWebHookController : isRock.LineBot.LineWebHookControllerBase
    {
        ...
        {
            const string AdminUserId = "__________AdminUserId_________"; //👉repleace it with your Admin User Id

            try
            {
                //設定ChannelAccessToken
                this.ChannelAccessToken = "______ChannelAccessToken______"; //👉repleace it with your Channel Access Token
                //配合Line Verify
